...
export function calculateSimilarity(
  ...
  if (!isBracketMatched) {
      const parts1 = extractSignificantParts(cleanTitle1NoChannel); console.log("parts1:", parts1);
      const parts2 = extractSignificantParts(cleanTitle2NoChannel); console.log("parts2:", parts2); console.log("clean2NoKw:", clean2NoKw);
